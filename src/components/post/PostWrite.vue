    ...
    <div>
        <div class="post-write-container">
            <div class="post-title-container">
                ...
                <input type="text" class="title-input" placeholder="여기에 제목을 입력하세요" v-model="title" />
            </div>
            ...
            <div class="editor-container">
                ...
                <input type="text" class="content-input" placeholder="여기에 내용을 입력하세요" v-model="content" />

                <input type="number" class="useFile" v-model="isUseFile" hidden >
            </div>
            <!-- Submit button -->
            <button class="submit-button" @click="submitPost">글 작성하기</button>
            </div>
